...
# Configuration
model_path = r"/content/SD-HD converter/ESRGAN/models/RRDB_ESRGAN_x4.pth"
...
def upsample_video(input_video_path, output_video_path, model_path=model_path, device=device, frame_skip=2):
    ...
    if not output_video_path.lower().endswith(('.avi', '.mp4', '.mov', '.mkv')):
...
upsample_video(input_video_path=r"/content/SD-video-to-HD-video-convertor/ESRGAN/Videoes/Input/balcony_sample.mp4",
               output_video_path=r"/content/SD-video-to-HD-video-convertor/ESRGAN/Videoes/Output/balcony_sample_upscaled.mp4",
               device=device,
